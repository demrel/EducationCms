    ...
    this.each(function() {
      ...
      <div class="imageuploadify well">
        ...
        <div class="imageuploadify-images-list text-center">
          <span class='imageuploadify-message'>Gallery Images: Drag and Drop here</span>
          <button type="button" class="btn btn-default">or select from here</button>
        </div>
      </div>
      `);
      ...
      const readingFile = (id, file) => {
        ...
        let container = $(`<div class='imageuploadify-container'>
          <button type='button' class='btn btn-danger glyphicon glyphicon-remove fas fa-times'></button>
      ...
      $(self).closest("form").on("submit", function(event) {
        ...
        // Add all data to the form (selected options, checked inputs, etc...).
          ...
          else if ($(inputs[index]).attr("type") != "file") {
            formData.append(inputs[index].name, inputs[index].value);  
              }
